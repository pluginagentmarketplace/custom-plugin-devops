...
This guide provides comprehensive documentation for the **assets** skill in the custom-plugin-devops plugin.
...
```bash
# Invoke the skill
claude "assets - [your task description]"

# Example
claude "assets - analyze the current implementation"
```
...
def implement_assets(input_data):
    """
    Implement assets functionality.
